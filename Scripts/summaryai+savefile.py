...
def detect_category(website_text):
    ...
    shortened_text = website_text[0:1000]
    print(website_text)
    message = f"""
...
"""
    try:
        ...
        messages = [
            {'role': 'system', 'content': "You are a helpful assistant tasked with analyzing and summarizing website content. Analyze the website based on the following points."},
